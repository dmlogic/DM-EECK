...
/***************************************************************************
 * Include the integration library for EE CK
 */
if ( ! isset($_SESSION)) @session_start();
if(! isset($_SESSION['eeck']['integration_path']) ) {
	exit( 'Access denied - system configuration error' );
}
require_once($_SESSION['eeck']['integration_path'].'ck.integrator.php');
/***************************************************************************/
...
function CheckAuthentication()
{
	...
	// EE CK authentication
	return Ck_integrator::authenticate();
}
...
// EE CK base_url
$baseUrl = Ck_integrator::base_url();
...
// EE CK base_dir
$baseDir = Ck_integrator::base_dir();
...
$config['Thumbnails'] = Array(
		...
		'enabled' => true,
		'directAccess' => true,
		'maxWidth' => Ck_integrator::thumbs('width'),
		'maxHeight' => Ck_integrator::thumbs('height'),
		'bmpSupported' => false,
		'quality' => Ck_integrator::thumbs('quality'));
...
// EE CK access control
$config['AccessControl'] = Ck_integrator::access_control();
...
// EE CK Resource types
$config['ResourceType'] = Ck_integrator::resource_types();
